...
class Captcha {
  ...
  private $capF = __DIR__ . DIRECTORY_SEPARATOR . "../assets/TuffyBold.ttf"; // captcha font
  private $capFS = 24; // captcha font size
  private $capB = __DIR__ . DIRECTORY_SEPARATOR . "../assets/CapBack.jpg"; // captcha background
